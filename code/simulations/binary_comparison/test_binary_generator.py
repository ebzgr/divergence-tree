...
def main():
    ...
    out_dir = repo_root / "outputs" / "figures" / "legacy_binary_generator"
    out_dir.mkdir(parents=True, exist_ok=True)
    # Plot outcome distributions
    plot_outcome_distributions(YF, YC, T, save_path=str(out_dir / "outcome_distributions.png"))

    # Plot treatment effects
    plot_treatment_effects(
        tauF, tauC, region_type, save_path=str(out_dir / "treatment_effects.png")
    )
